 ...
 */
function theme_amelia_logo($theme) {
 ...
 * @return bool
 */
function theme_amelia_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM && ($filearea === 'logo')) {
        $theme = theme_config::load('amelia');
 ...
 */
function theme_amelia_set_customcss($css, $customcss) {
